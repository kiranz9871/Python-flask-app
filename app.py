...
def home():
    REQUEST_COUNT.inc()
    return "Hi Developers this one for you , your app is working fine, happy coding! 🚀,this is very simple flask app, i love learning new things, flask is so easy to use, i am enjoying it , and i love it "
